...
# データベースjsonの読み込み
with open('../database/RoomUsageSchedule.json', 'r') as f:
    RoomUsageSchedule = json.load(f)
with open('../database/lightingControl.json', 'r') as f:
    lightingCtrl = json.load(f)
with open('../database/ROOM_STANDARDVALUE.json', 'r') as f:
...
resultJson["BEI_L"] = E_lighting / Es_lighting
