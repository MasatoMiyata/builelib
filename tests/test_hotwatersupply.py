...
def calculation(filename):
    ...
    for data in testdata:
        ...
        if data[9] == "" and data[13] == "" and data[20] == "" and data[32] == "":  # 計算モデルの作成（1室1系統の場合）
        ...
        elif data[9] != "" and data[13] == "" and data[20] == "" and data[32] != "":  # 計算モデルの作成（1室2系統の場合）
        ...
        elif data[9] == "" and data[13] != "" and data[20] == "" and data[32] != "":  # 計算モデルの作成（2室2系統の場合）
        ...
        elif data[9] == "" and data[13] != "" and data[20] == "" and data[32] == "":  # 計算モデルの作成（2室1系統の場合）
        ...
        elif data[9] != "" and data[13] != "" and data[20] != "" and data[32] != "":  # 計算モデルの作成（2室共通2系統の場合）
...
def test_hotwatersupply_clumate_area():
    calculation('./tests/hotwatersupply/基本テスト.txt')
